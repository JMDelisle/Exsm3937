...
CREATE TABLE Order_Header( 
    ...
    FOREIGN KEY (order_header_id) REFERENCES customer(customer_id)  
);
...
ALTER TABLE
    order_detail
ADD
    FOREIGN KEY order_header_id REFERENCES order_header order_header_id ON DELETE RESTRICT ON UPDATE RESTRICT;
